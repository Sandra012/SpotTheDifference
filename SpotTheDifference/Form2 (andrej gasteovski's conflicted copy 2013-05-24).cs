...
namespace SpotTheDifference
{
    public partial class Form2 : Form
    {
        ...
        ImagePair pair = null;
        private Ball ball=new Ball(Color.Coral, 410,560);
        private Line line=new Line(new Point(410, 560), new Point(620, 560), 3);

        public Form2() {
            InitializeComponent();
            ball = new Ball(Color.Coral,410,560);
            line = new Line(new Point(410, 560), new Point(620, 560), 3);
        }
